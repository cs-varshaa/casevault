      ...
      <aside class="sidebar ${isCollapsed ? 'collapsed' : ''}" id="app-sidebar">
          ...
          <a href="#" class="brand" data-view="dashboard">
            ...
            <div class="brand-info">
              <span class="brand-title">
                CASEVAULT
                <span class="brand-tag">SIH '26</span>
              </span>
              <span class="brand-tagline">LEGAL EVIDENCE VAULT</span>
            </div>
          </a>
        ...
        <nav class="sidebar-nav">
          ...
          <a class="nav-item ${activeView === 'verifier' ? 'active' : ''}" data-view="verifier">
            ...
            <span class="nav-label">Integrity & PKI</span>
          </a>
          ...
          <a class="nav-item ${activeView === 'notifications' ? 'active' : ''}" data-view="notifications">
            ...
            ${unreadCount > 0 ? `<span class="nav-badge alert">${unreadCount}</span>` : ''}
          </a>
